...
- Incident response procedures (containment, eradication, and recovery)  
- Attack simulation including phishing, brute-force, and privilege escalation scenarios  
- Investigation documentation and reporting  
---
## Tools & Technologies
- **Splunk** – Log aggregation and security event analysis  
- **Suricata** – Intrusion Detection/Prevention System (IDS/IPS) for network monitoring  
- **Wireshark** – Network traffic and packet analysis  
- **Log Forwarders** – Centralized log collection from endpoints and systems
